  ...
  return (
    <AnnouncementContext.Provider value={announcement}>
      <div className='w-[1100px] max-w-[85vw]'>
        ...
        <h2 className='text-[#1D2433] font-semibold text-3xl mb-2 tracking-[-1px]'>
          Announcements
        </h2>
        <p className='text-[#676E7E] font-medium text-base mb-7'>
          Create new announcements{' '}
        </p>
        <div
          className={`${
            announcement ? '' : ''
          } relative bg-white px-[24px] pt-[24px] pb-[0px] flex flex-col gap-[32px]`}
        >
