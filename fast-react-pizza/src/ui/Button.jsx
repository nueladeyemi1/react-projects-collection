...
const Button = ({ children, disabled, to, type, onClick }) => {
  ...
  const styles = {
    primary: base + " md:px-6 sd:py-4 px-4 py-3 ",
    small: base + " md:px-5 md:py-2.5 px-4 py-2 text-xs",
    secondary:
      "inline-block text-sm rounded-full border-2 border-stone-400 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:text-stone-800 hover:bg-stone-300 focus:outline-none focus:text-stone-800 focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 sd:py-3.5 px-4 py-2.5",
    round: base + " md:px-3.5 md:py-2 px-2.5 py-1 text-ms",
  };
